    ...
    */
    <ScrollView style={styles.container}>
        ...
        <Text style={styles.weather}>오늘의 날씨: {todayWeather + '°C ' + todayCondition} </Text>
          <TouchableOpacity style={styles.introButton} onPress={()=>{navigation.navigate('AboutPage')}}><Text style={styles.middleButtonTextAll}>소개 페이지</Text></TouchableOpacity>
